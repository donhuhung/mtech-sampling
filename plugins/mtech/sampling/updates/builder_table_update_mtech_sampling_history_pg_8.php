...
class BuilderTableUpdateMtechSamplingHistoryPg8 extends Migration
{
    public function up()
    {
        Schema::table('mtech_sampling_history_pg', function($table)
        {
            ...
            $table->string('longitude_checkin', 191)->default('null')->change();
            $table->string('latitude_chekin', 191)->default('null')->change();
            $table->string('longitude_checkout', 191)->default('null')->change();
            $table->string('latitude_checkout', 191)->default('null')->change();
        });
    }
